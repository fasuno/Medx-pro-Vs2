...
Public Class TheatreDrugs
    ...
    Private Sub Btnnew_Click(sender As Object, e As EventArgs) Handles Btnnew.Click
        ...
        FrmDrugsPresc.BtnSAveTheatre.BringToFront()
        FrmDrugsPresc.txtdiag.Text = FrmSurgery.TxtDiag.Text
    ...
    Private Sub DtgDrugshx_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DtgDrugshx.CellMouseDoubleClick
        ...
        FrmDrugPreview.ShowDrugsForTheatre()
